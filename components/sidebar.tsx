...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 flex-shrink-0 hidden md:block border-r border-gray-200 dark:border-gray-800 overflow-hidden">
      <div className="py-6 px-0 h-full flex flex-col" id="sidebar-nav">
        <nav className="space-y-1">
          ...
          <Link
            href="#"
            className="flex items-center gap-3 py-3 px-4 hover:bg-gradient-to-r hover:from-gray-100/80 dark:hover:from-gray-800/80 hover:to-transparent font-light"
          >
