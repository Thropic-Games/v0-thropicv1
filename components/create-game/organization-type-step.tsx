  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card
          className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 hover:border-amber-500 dark:hover:border-yellow-500 cursor-pointer transition-all"
          onClick={() => onSelect("nonprofit")}
        >
          <CardContent className="p-6 flex flex-col items-center text-center">
            <Building2 className="h-12 w-12 text-amber-500 dark:text-yellow-500 mb-4" />
        ...
        >
          <CardContent className="p-6 flex flex-col items-center text-center">
            <Users className="h-12 w-12 text-amber-500 dark:text-yellow-500 mb-4" />
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm">
              ...
              churches, and other community groups. You'll need to set up payment processing.
            </p>
          </CardContent>
        </Card>
      </div>
