...
import { Trophy, Heart, Users, BanknoteIcon as BankIcon, Camera, Edit, Settings } from "lucide-react"
                    ...
                    <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
                      ...
                      <div className="flex-1 text-center md:text-left">
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                          <div>
                            <h1 className="text-2xl font-medium">Gabriel Erickson</h1>
                            <p className="text-gray-400 font-light">@gabriel_erickson</p>
                          </div>
                          <div className="mt-2 md:mt-0 flex justify-center md:justify-end gap-2">
                            ...
                            <Button variant="outline" size="sm" className="h-9 bg-gray-800 border-gray-700">
